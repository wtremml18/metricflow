        ...
        INNER JOIN (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                bookings_monthly_source_src_10010.bookings_monthly
                , DATE_TRUNC('month', bookings_monthly_source_src_10010.ds) AS monthly_ds__month
                , DATE_TRUNC('quarter', bookings_monthly_source_src_10010.ds) AS monthly_ds__quarter
                , DATE_TRUNC('year', bookings_monthly_source_src_10010.ds) AS monthly_ds__year
                , EXTRACT(year FROM bookings_monthly_source_src_10010.ds) AS monthly_ds__extract_year
                , EXTRACT(quarter FROM bookings_monthly_source_src_10010.ds) AS monthly_ds__extract_quarter
                , EXTRACT(month FROM bookings_monthly_source_src_10010.ds) AS monthly_ds__extract_month
                , DATE_TRUNC('month', bookings_monthly_source_src_10010.ds) AS booking__monthly_ds__month
                , DATE_TRUNC('quarter', bookings_monthly_source_src_10010.ds) AS booking__monthly_ds__quarter
                , DATE_TRUNC('year', bookings_monthly_source_src_10010.ds) AS booking__monthly_ds__year
                , EXTRACT(year FROM bookings_monthly_source_src_10010.ds) AS booking__monthly_ds__extract_year
                , EXTRACT(quarter FROM bookings_monthly_source_src_10010.ds) AS booking__monthly_ds__extract_quarter
                , EXTRACT(month FROM bookings_monthly_source_src_10010.ds) AS booking__monthly_ds__extract_month
                , bookings_monthly_source_src_10010.listing_id AS listing
                , bookings_monthly_source_src_10010.listing_id AS booking__listing
              FROM ***************************.fct_bookings_extended_monthly bookings_monthly_source_src_10010
            ) subq_0
          ) subq_1
