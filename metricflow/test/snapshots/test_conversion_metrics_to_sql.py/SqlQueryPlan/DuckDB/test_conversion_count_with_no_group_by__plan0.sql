    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            1 AS visits
            , visits_source_src_10069.user_id AS visitors
            , DATE_TRUNC('day', visits_source_src_10069.ds) AS ds__day
            , DATE_TRUNC('week', visits_source_src_10069.ds) AS ds__week
            , DATE_TRUNC('month', visits_source_src_10069.ds) AS ds__month
            , DATE_TRUNC('quarter', visits_source_src_10069.ds) AS ds__quarter
            , DATE_TRUNC('year', visits_source_src_10069.ds) AS ds__year
            , EXTRACT(year FROM visits_source_src_10069.ds) AS ds__extract_year
            , EXTRACT(quarter FROM visits_source_src_10069.ds) AS ds__extract_quarter
            , EXTRACT(month FROM visits_source_src_10069.ds) AS ds__extract_month
            , EXTRACT(day FROM visits_source_src_10069.ds) AS ds__extract_day
            , EXTRACT(isodow FROM visits_source_src_10069.ds) AS ds__extract_dow
            , EXTRACT(doy FROM visits_source_src_10069.ds) AS ds__extract_doy
            , visits_source_src_10069.referrer_id
            , DATE_TRUNC('day', visits_source_src_10069.ds) AS visit__ds__day
            , DATE_TRUNC('week', visits_source_src_10069.ds) AS visit__ds__week
            , DATE_TRUNC('month', visits_source_src_10069.ds) AS visit__ds__month
            , DATE_TRUNC('quarter', visits_source_src_10069.ds) AS visit__ds__quarter
            , DATE_TRUNC('year', visits_source_src_10069.ds) AS visit__ds__year
            , EXTRACT(year FROM visits_source_src_10069.ds) AS visit__ds__extract_year
            , EXTRACT(quarter FROM visits_source_src_10069.ds) AS visit__ds__extract_quarter
            , EXTRACT(month FROM visits_source_src_10069.ds) AS visit__ds__extract_month
            , EXTRACT(day FROM visits_source_src_10069.ds) AS visit__ds__extract_day
            , EXTRACT(isodow FROM visits_source_src_10069.ds) AS visit__ds__extract_dow
            , EXTRACT(doy FROM visits_source_src_10069.ds) AS visit__ds__extract_doy
            , visits_source_src_10069.referrer_id AS visit__referrer_id
            , visits_source_src_10069.user_id AS user
            , visits_source_src_10069.session_id AS session
            , visits_source_src_10069.user_id AS visit__user
            , visits_source_src_10069.session_id AS visit__session
          FROM ***************************.fct_visits visits_source_src_10069
        ) subq_0
      ) subq_1
    ) subq_2
  ) subq_3
          ...
          INNER JOIN (
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  1 AS buys
                  , buys_source_src_10060.user_id AS buyers
                  , DATE_TRUNC('day', buys_source_src_10060.ds) AS ds__day
                  , DATE_TRUNC('week', buys_source_src_10060.ds) AS ds__week
                  , DATE_TRUNC('month', buys_source_src_10060.ds) AS ds__month
                  , DATE_TRUNC('quarter', buys_source_src_10060.ds) AS ds__quarter
                  , DATE_TRUNC('year', buys_source_src_10060.ds) AS ds__year
                  , EXTRACT(year FROM buys_source_src_10060.ds) AS ds__extract_year
                  , EXTRACT(quarter FROM buys_source_src_10060.ds) AS ds__extract_quarter
                  , EXTRACT(month FROM buys_source_src_10060.ds) AS ds__extract_month
                  , EXTRACT(day FROM buys_source_src_10060.ds) AS ds__extract_day
                  , EXTRACT(isodow FROM buys_source_src_10060.ds) AS ds__extract_dow
                  , EXTRACT(doy FROM buys_source_src_10060.ds) AS ds__extract_doy
                  , DATE_TRUNC('day', buys_source_src_10060.ds) AS buy__ds__day
                  , DATE_TRUNC('week', buys_source_src_10060.ds) AS buy__ds__week
                  , DATE_TRUNC('month', buys_source_src_10060.ds) AS buy__ds__month
                  , DATE_TRUNC('quarter', buys_source_src_10060.ds) AS buy__ds__quarter
                  , DATE_TRUNC('year', buys_source_src_10060.ds) AS buy__ds__year
                  , EXTRACT(year FROM buys_source_src_10060.ds) AS buy__ds__extract_year
                  , EXTRACT(quarter FROM buys_source_src_10060.ds) AS buy__ds__extract_quarter
                  , EXTRACT(month FROM buys_source_src_10060.ds) AS buy__ds__extract_month
                  , EXTRACT(day FROM buys_source_src_10060.ds) AS buy__ds__extract_day
                  , EXTRACT(isodow FROM buys_source_src_10060.ds) AS buy__ds__extract_dow
                  , EXTRACT(doy FROM buys_source_src_10060.ds) AS buy__ds__extract_doy
                  , buys_source_src_10060.user_id AS user
                  , buys_source_src_10060.session_id
                  , buys_source_src_10060.user_id AS buy__user
                  , buys_source_src_10060.session_id AS buy__session_id
                FROM ***************************.fct_buys buys_source_src_10060
              ) subq_7
            ) subq_8
          ) subq_9
          ON
